<?php
    ...
    $query2 = "SELECT * FROM tutor WHERE nama = 'Katya Lischina'";
        ...
        <article>
            ...
            <div class="row">
                ...
                <div class="col-md-11" id="form-box" style="height:600px;margin-bottom: 50px">
                    <div class="row">
                        <div class="col-md-3">
                            <img src="pas7.jpg" style="border: solid  #bebebe">
                        </div>
                        <div class="col-md-9 ">
                            <p style="text-align:justify"> Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Ut excepturi incidunt corrupti veritatis, accusantium nisi similique eum quas tenetur
                                ducimus quo, quam reprehenderit esse saepe?
